...
const ServicesSection: React.FC = () => {
  ...
  const services: Service[] = content?.services && Array.isArray(content.services) && content.services.length > 0 ? content.services : fallbackServices;
  return <section id="services" className="section-padding bg-white">
      <div className="container-custom">
        <div className="text-center mb-20 max-w-4xl mx-auto">
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-6 text-primary py-px">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          ...
          return <div key={idx} className="group bg-white border border-gray-100 rounded-2xl p-8 text-center animate-fade-in hover:shadow-glow hover:border-accent/20 transition-all duration-300" style={{
            animationDelay: `${idx * 0.1}s`
          }}>
                {IconComponent && <div className="relative mb-8 mx-auto w-20 h-20 flex items-center justify-center">
