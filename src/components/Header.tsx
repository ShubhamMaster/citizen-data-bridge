        ...
        <div className="flex justify-between items-center py-4">
          ...
          <div className="flex items-center space-x-3">
            <Link to="/" className="flex items-center space-x-3 group">
              <div className="relative w-12 h-12 sm:w-14 sm:h-14 flex-shrink-0">
                <img src="/lovable-uploads/dbdd7bff-f52d-46d3-9244-f5e7737d7c95.png" alt="Civora Nexus Logo" className="w-full h-full object-contain transition-transform duration-300 group-hover:scale-110" />
          ...
          <div className="hidden md:flex items-center space-x-3">
            {isLoggedIn ? <div className="flex items-center space-x-3">
                <Link to="/admin" className="text-gray-700 hover:text-civora-navy transition-colors p-2 rounded-lg hover:bg-gray-50">
          ...
          <div className="md:hidden">
            <button onClick={() => setIsMenuOpen(!isMenuOpen)} className="text-gray-700 hover:text-civora-navy p-2 rounded-lg hover:bg-gray-50 transition-colors">
            ...
            <nav className="flex flex-col space-y-2 pt-4">
              ...
              <div className="pt-4 space-y-3 border-t border-gray-100">
                {isLoggedIn ? <>
                    ...
                    <Button variant="outline" className="w-full border-gray-300 hover:border-civora-teal hover:text-civora-teal" size="sm" onClick={() => {
                setIsLoggedIn(false);
                setIsMenuOpen(false);
              }}>
                      Logout
