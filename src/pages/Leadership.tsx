  ...
  return <div className="min-h-screen bg-white dark:bg-gray-900 flex flex-col">
      ...
      <section className="bg-gradient-to-br from-civora-navy to-civora-navy/90 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-3xl lg:text-5xl font-bold mb-4 text-gray-950">Our Leadership Team</h1>
            <p className="text-xl max-w-3xl mx-auto font-normal text-gray-600">
      ...
      <main className="flex-1 max-w-6xl mx-auto py-16 px-4">
        <section className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          {leadershipTeam.map(leader => <Card key={leader.name} className="flex flex-col items-center text-center shadow-md hover-scale transition-all duration-200">
              <CardHeader className="flex flex-col items-center">
                <img src={leader.image} alt={leader.name} className="w-32 h-32 rounded-full object-cover border-4 border-civora-teal mb-3 shadow" loading="lazy" />
