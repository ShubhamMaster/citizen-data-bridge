...
const Terms = () => {
  const sections = [{
    ...
    list: ["modify or copy the materials", "use the materials for any commercial purpose or for any public display", "attempt to reverse engineer any software contained on the website", "remove any copyright or other proprietary notations from the materials"]
  }, {
  ...
  return <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50">
      ...
      <section className="relative bg-gradient-to-br from-civora-navy via-civora-navy/95 to-civora-navy/90 text-white py-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-4xl lg:text-6xl font-bold mb-6 text-gray-950">
            Terms of <span className="bg-clip-text bg-gradient-to-r from-civora-teal to-cyan-400 text-gray-950">Service</span>
          </h1>
          <p className="text-xl max-w-3xl mx-auto leading-relaxed font-normal text-gray-700">
      ...
      <section className="py-16 lg:py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8">
            {sections.map((section, index) => <Card key={index} className="overflow-hidden border-0 shadow-lg hover:shadow-xl transition-all duration-300 bg-white/70 backdrop-blur-sm">
                ...
                <CardContent className="p-6 lg:p-8">
                  <div className="text-gray-600 leading-relaxed space-y-4">
                    ...
                    {section.list && <div className="mt-4">
                        ...
                        <ul className="space-y-2 ml-4">
                          {section.list.map((item, listIndex) => <li key={listIndex} className="flex items-start gap-3">
                    ...
                    {section.contactEmail && <div className="mt-4 p-4 bg-civora-teal/5 rounded-lg border border-civora-teal/20">
                        <a href={`mailto:${section.contactEmail}`} className="inline-flex items-center gap-2 text-civora-teal hover:text-civora-navy transition-colors font-medium">
