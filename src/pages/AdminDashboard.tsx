  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Main dashboard content area with tab navigation always visible */}
        <div>
          <Tabs defaultValue="applications" className="space-y-6">
            ...
            {/* When showVisitorsTable is true, render only the visitors table in the content area */}
            {showVisitorsTable ? (
              <div className="mt-6">
                <Card>
                  <CardHeader>
              ...
              <>
                {/* ALL TABS CONTENTS VISIBLE WHEN visitors table is NOT open */}
