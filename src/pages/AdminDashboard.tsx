...
const AdminDashboard = () => {
  ...
  // Helper to render tab content by value (only renders inner content, NOT TabsContent)
  function renderTabContent(tab: string) {
    switch (tab) {
      ...
      case "jobs":
        return (
          <div>
            {/* Copy the content inside <TabsContent value="jobs">, but NOT the wrapper */}
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8 py-6">
        ...
        <div>
          ...
          {/* On mobile, just show direct content of selected tab (NOT using TabsContent) */}
  ...
  // Helper to render tab panel by value (only renders inner content, NOT TabsContent)
  function renderTabPanel(tab: string) {
    switch (tab) {
      case "applications":
        return (
          <Card>
